...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // check and init global image url and image dictionary
    if (nil == gImgUrlImageDictionary) {
        gImgUrlImageDictionary = [[NSMutableDictionary alloc] init];
    }
    
    // init tab bar controller
    _tabBarController = [[TabBarController alloc] initWithNibName:nil bundle:nil];
